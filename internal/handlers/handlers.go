...
import (
	...
	"github.com/JZilla808/bookings/internal/forms"
	...
	"github.com/JZilla808/bookings/internal/repository"
	"github.com/JZilla808/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	htmlMessage = fmt.Sprintf(`
		<strong>You have new reservation!</strong><br>
		Dear Room Owner: <br>
		A new reservation has been made to room: %s <br>
		Guest name: %s %s <br>
		From %s to %s
...
// AdminShowReservation displays the reservation in admin tool
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: this might cause a error when marking a reservation as processed
...
// AdminShowReservation displays the reservation calendar
